#!/usr/bin/env bash
# Missing IRCADb external validation, GPU0 parallel group B.
#
# Run together with:
...
#   NO_VIS=1 bash pumengyu/notes/sh/run_missing_external_v2_gpu0_b.sh
#   FORCE=1 bash pumengyu/notes/sh/run_missing_external_v2_gpu0_b.sh
...
log "Repo: $REPO_ROOT"
log "Group=B GPU=$GPU NO_VIS=$NO_VIS FORCE=$FORCE STOP_ON_FAIL=$STOP_ON_FAIL"
echo ""
